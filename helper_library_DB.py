"""
This is a helper library that includes a couple of classes to assist in running tests for the API
"""
...
class Dropbox(object):
    ...
    def db_search(self, my_data2):
        my_headers2 = {
        "Authorization": "Bearer Wvf7h-SwacMAAAAAAAAEDlwLfld0CIMHySGJZuWrYWwQo-lPu8ukW3Qbd3vsx2C8",
